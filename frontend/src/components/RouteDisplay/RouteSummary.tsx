...
const RouteSummary = ({ summary, isVisible, onToggle, onClearRoute: _onClearRoute }: RouteSummaryProps) => {
  ...
  return (
    <div
      ...
      style={{
        transform: isVisible ? `translateY(${dragOffset}px)` : ``,
    ...
    >
      {/* 拖曳指示器和收合時的標題列 */}
      <div
        className="cursor-pointer select-none active:bg-gray-50"
        ...
        aria-label={isVisible ? '收合路線統計' : '展開路線統計'}
      >
        {/* 拖曳指示器 */}
        <div className="flex justify-center py-3" style={{ padding: '1.25rem 0' }}>
        ...
        {!isVisible && (
          <div className="px-4 pb-4">
            <div className="flex items-center justify-between">
              <h3 className="text-base font-semibold text-text-primary">路線安全評估</h3>
              <div className="flex items-center gap-2">
                <span className="text-sm text-text-secondary">{totalAccidents} 筆事故</span>
                <svg
